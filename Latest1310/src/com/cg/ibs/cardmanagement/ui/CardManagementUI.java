	...
	void listExistingCreditCards() {
		...
		if (creditCardBeans.isEmpty()) {
			...
			for (CreditCardBean creditCardBean : creditCardBeans) {
				...
				System.out
						.println("Credit card date of expiry(yyyy/MM/dd):\t" + creditCardBean.getCreditDateOfExpiry());
	...
	void replyQueries() {
		...
		if (check) {
			...
			while (!success) {
				...
				System.out.println("..........................................");
				System.out.println("1 for Query Approved...... ");
				System.out.println("2 for Query In Process.....");
				System.out.println("3 for Query Disapproved ...");
